<?php  if(!defined('_source')) die("Error");
	...
	$d->reset();
	if($strDetail !=''){
		$sql_detail = "select id,id_list,ten_$lang as ten,tenkodau,thumb,thumb1,thumb2,alt,mota_$lang as mota,noidung_$lang as noidung,title_$lang as title,description_$lang as description,keywords_$lang as keywords,date_create,viewed from #_news where tenkodau='".$strDetail."'";
		$d->query($sql_detail);
		...
		$d->reset();
		$sql_khac = "select id,ten_$lang as ten,tenkodau,date_create from #_news where shows=1 and id!=".$news_detail['id'];		
		...
		$sql = "select id,ten_$lang as ten,tenkodau,thumb,thumb1,thumb2,alt,mota_$lang as mota,date_create from #_news where shows=1 order by numberic asc,id desc";
		$d->query($sql);
		$news = $d->result_array();
