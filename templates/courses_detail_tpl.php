<div class="breadcrumb clearfix">
    ...
    <span class="navigation_page">
        <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
            <a itemprop="url" href="huong-dan-che-bien-mon-an/" title="Hướng dẫn chế biến món ăn">
            <span itemprop="title">Hướng dẫn chế biến món ăn</span></a>
        </span>
    ...
    <div class="row">
		<div class="col-xs-12 col-sm-12">
			<ul class="o-nav">
				...
				<li>
					<a href="http://<?=$config_url.'/huong-dan-che-bien-mon-an/'.$news[$i-1]['tenkodau']?>.html" class="transitionAll"><i class="fa fa-caret-right"></i> <?=$news[$i-1]['ten']?> <span>(<?=date('d-m-Y',$news[$i-1]['date_create'])?>)</span></a>
				</li>
				<?php } ?>
			</ul>
		</div>
