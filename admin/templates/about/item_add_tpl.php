...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=about&act=save" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-lg-12">
									<!--<div class="form-group row">
										...
										<div class="col-lg-8"><?php /* print get_select_list($_REQUEST['id_list'],'about_list','id_list'); */ ?></div>
									</div>-->
                                    <div class="form-group row">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
                                    <!--<div class="form-group row">
                                        <div class="col-lg-12"><b style="color: #142CE8;">Lưu ý: Nếu cả 'Video' và hình 'Photo' phía dưới đều có, sẽ ưu tiên hiển thị video ra ngoài website</b></div>
                                    </div>
                                    <div class="form-group row">    
										<div class="col-lg-2"><b>Video link</b></div>
										<div class="col-lg-3">
                                            <?php if($item['video_link']!=NULL) {echo '<img src="http://img.youtube.com/vi/'.$item['video_link'].'/0.jpg" width="'._news_size_1_w.'" />';}?>
                                            <input type="text" name="video_link" value="<?=$item['video_link']?>" class="form-control" />
                                        </div>
                                        <div class="col-lg-7"><b>Copy mã youtube màu đỏ như VD: https://www.youtube.com/watch?v=<strong style="color: #ff0000;">1U2DKKqxHgE</strong></b></div>
									</div>-->
                                    
									<div class="form-group row">
										<div class="col-lg-2"><b>Photo</b></div>
										<div class="col-lg-5">
											<?php if($item['thumb']!=NULL) {echo '<img src="http://'.$config_url.'/'._upload_news_l.$item['thumb'].'" width="200" />';}?>
											<input type="file" name="photo" />
										</div>
										<div class="col-lg-3"><b><?php print _default_type; ?></b></div>
										<div class="col-lg-2"><b><?php print _about_size; ?></b></div>
									</div>
									<div class="form-group row">
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=about&act=man'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>