...
<table class="blue_table">
	...
	<tr>
		...
		<td style="width:5%;"><a href="index.php?com=user&act=delete&id=<?=$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" /></a></td>
	</tr>
	<?php	}?>
</table>
<a href="index.php?com=user&act=add"><img src="media/images/add.jpg" class="function"  /></a>
