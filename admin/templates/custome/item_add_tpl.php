...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=custome&act=save" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="form-group row">
								...
								<div class="col-lg-4">
									<?php if($item['photo']!=NULL) {echo '<img src="http://'.$config_url.'/'._upload_hinhanh_l.$item['photo'].'" width="140" />';}?>
									<input type="file" name="photo" />
								</div>
								<div class="col-lg-2">.jpg | .png | .gif </div>
								<div class="col-lg-2">(140 x 90px)</div>
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=custome&act=man'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>