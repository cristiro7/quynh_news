...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=service&act=save" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-lg-12">
									<!--<div class="form-group row">
										...
										<div class="col-lg-8"><?=get_select_list($_REQUEST['id_list'],'service_list','id_list')?></div>
									</div>-->
                                    <div class="form-group row">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group row">
										...
										<div class="col-lg-5">
											<?php if($item['thumb1']!=NULL) {echo '<img src="http://'.$config_url.'/'._upload_news_l.$item['thumb1'].'" width="'._news_size_1_w.'" />';}?>
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=service&act=man'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>