...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=product&act=save_item" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group row">
										...
										<div class="col-lg-8"><?=get_select_list($_REQUEST['id_cat'],'product_cat','id_cat','id_list',$_REQUEST['id_list'])?></div>
									</div>
									<div class="form-group row">
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=product&act=man_item'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>
