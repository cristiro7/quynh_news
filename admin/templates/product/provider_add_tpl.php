...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=product&act=save_provider" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group row">
										...
										<div class="col-lg-4">
											<?php if($item['photo']!=NULL) {echo '<img src="http://'.$config_url.'/'._upload_product_l.$item['photo'].'" width="150" />';}?>
											<input type="file" name="photo" />
										</div>
										<div class="col-lg-2">.jpg | .png | .gif</div>
										<div class="col-lg-2">(200 x 70px)</div>
									</div>
									<div class="form-group row">
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=product&act=man_provider'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>