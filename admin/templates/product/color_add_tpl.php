...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=product&act=save_color" enctype="multipart/form-data">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group row">
										<div class="col-lg-2"><b>Chọn màu</b></div>
										<div class="col-lg-8"><input type="color" name="color" value="<?=$item['color']?>" class="form-control" style="width: 50px;" /></div>
									</div>
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group row">
										...
										<div class="col-lg-2"><b>(200 x 70px)</b></div>
									</div>
									<div class="form-group row">
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=product&act=man_color'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>