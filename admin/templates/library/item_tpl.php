					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							...
							<tr class="<?php if($i%2 !=0){echo 'odd';}else{echo 'even';}?> gradeA">
								...
								<td><a href="http://<?=$config_url?>/admin/index.php?com=news&act=edit&id=<?=$items[$i-1]['id']?>" ><?=$items[$i-1]['ten_vi']?></a></td>
								<td><?php if($items[$i-1]['photo']){?><a href="index.php?com=news&act=edit&id=<?=$items[$i-1]['id']?>" ><img src="http://<?=$config_url.'/'._upload_news_l.$items[$i-1]['thumb']?>" height="50"><?php } ?></a></td>
								<td>
								<?php if($items[$i-1]['shows_popup']==1){?>
									<a href="http://<?=$config_url?>/admin/index.php?com=news&act=man&shows_popup=<?=$items[$i-1]['id']?>"><i class="fa fa-check-square-o fa-lg"></i></a>
								<?php }else{?>
									<a href="http://<?=$config_url?>/admin/index.php?com=news&act=man&shows_popup=<?=$items[$i-1]['id']?>"><i class="fa fa-square-o fa-lg"></i></a>
								<?php } ?>
								</td>
								<td>
								...
								<td><a href="http://<?=$config_url?>/admin/index.php?com=news&act=edit&id=<?=$items[$i-1]['id']?>" ><i class="fa fa-pencil fa-lg"></a></td>
