...
<!--								<td>--><?//=$items[$i-1]['position']?><!--</td>-->
								<td><?php if($items[$i-1]['photo']){?><a href="index.php?com=advertise&act=edit&id=<?=$items[$i-1]['id']?>" ><img src="http://<?=$config_url.'/'._upload_hinhanh_l.$items[$i-1]['photo']?>" height="50"><?php } ?></a></td>
								<td><a href="http://<?=$config_url?>/admin/index.php?com=advertise&act=edit&id=<?=$items[$i-1]['id']?>" ><?=$items[$i-1]['link']?></a></td>
								<td>
								<?php if($items[$i-1]['shows']==1){?>
									<a href="http://<?=$config_url?>/admin/index.php?com=advertise&act=man&shows=<?=$items[$i-1]['id']?>"><i class="fa fa-check-square-o fa-lg"></i></a>
								<?php }else{?>
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<a href="http://<?=$config_url?>/admin/index.php?com=advertise&act=add" class="btn btn-default" >Thêm mới</a>
...
<script>
    $(document).ready(function() {
		...
		$("#delete_all").click(function(){
			...
			if (hoi==true) document.location = "index.php?com=advertise&act=delete&listid=" + listid;
		});
	...
	function selectChange(){
		var link = 'http://<?=$config_url?>/admin/index.php?com=advertise&act=man';
		var links ='';
