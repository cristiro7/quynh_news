...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=blog&act=save_list" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<?php if($item['thumb']!=NULL) {echo '<img src="http://'.$config_url.'/'._upload_blog_l.$item['thumb'].'" width="150" />';}?>
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=blog&act=man_list'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>