...
<div class="row">
	<div class="col-lg-12">
		<form name="frm" method="post" action="http://<?=$config_url?>/admin/index.php?com=place&act=save_city" enctype="multipart/form-data">
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='http://<?=$config_url?>/admin/index.php?com=place&act=man_city'" class="btn btn-default" />
			</p>
		</form>	
	</div>
</div>